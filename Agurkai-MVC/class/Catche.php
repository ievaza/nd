...
class Catche {
    ...
    public function __construct(){
        if(file_exists(__DIR__.'/../data/currency.json')){ //jiegu failas, kuriame saugau E
    ...
    public function set( object $data){ //siunciame duomenis kazkokius ir norime, kad tai butu obj 
        ...
        file_put_contents(__DIR__.'/../data/currency.json',json_encode($data)); // ir idedam sujsonintus duomenis
    }
}