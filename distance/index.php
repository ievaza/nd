...
if(!empty($_POST)){
 ...
 if(isset($_SESSION['distance'])){ // jei sesijoj kazkas setinta
    ...
    unset($_SESSION['distance'],  $_SESSION['t1'] ,  $_SESSION['t2'],  $_SESSION['img1'], $_SESSION['img2']); //kad perkrovus psl nebeislystu 
